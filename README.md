...
```bash
$ sam local invoke SeleniumFunction --event events/event.json
```
...
To delete the sample application that you created, use the SAM delete command and accept the delete prompts.
